...
describe('Test de APIS', () => {
  ...
  describe('POST /product', () => {
    ...
    it('responds with 400', () => agent.post('/product').send({a: 2, b: "adasdad"}).expect(400));
  ...
  describe('POST /sumArray', () => {
    ...
    it("should responds with false if no combination of two numbers matches num", () => {
      agent
        .post("/sumArray")
  ...
  describe("POST /numString", () => {
    it("responds with status 200", () => {
      agent.post("/numString").send({s: "tomas"}).expect(200)
    });
    it("responds with status 400 if the string is a number", () => {
      agent.post("/numString").send({s: 4}).expect(400)
    });
    it("responds with status 400 if the string is empy", () => {
